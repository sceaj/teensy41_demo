...
{
	PRINTF("SD_SetCardPower: Entering...\n");
    assert(card != NULL);
	...
	PRINTF("SD_SetCardPower: Leaving\n");
}
...
{
	PRINTF("SD_HostDoReset: Entering...\n");
    SDMMCHOST_Reset(card->host);
	PRINTF("SD_HostDoReset: Leaving\n");
}
